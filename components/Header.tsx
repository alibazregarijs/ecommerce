...
const Header = () => {
  return (
    <>
      ...
      <div className="flex justify-center items-center space-x-[106px] h-[122px] bg-black">
        <Image width={166}  height={34} src="/versache.png" alt="versache-logo"   />
        <Image width={92} height={38} src="/zara.png"  alt="zara-logo"  />
        <Image width={156} height={36} src="/gucci.png"  alt="zara-logo"  />
        <Image width={194} height={32} src="/prada.png"  alt="zara-logo"  />
        <Image width={206} height={34} src="/calvin.png"  alt="zara-logo"  />
      </div>
    </>
  );
};
